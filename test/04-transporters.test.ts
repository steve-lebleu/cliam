...
const HTTP_TRANSPORTERS = ['brevo-api', 'mailersend-api', 'mailgun-api', 'mailjet-api', 'mandrill-api', 'postmark-api', 'resend-api', 'ses-api', 'sendgrid-api', 'sparkpost-api'];
...
describe('Transporters', () => {
  ...
  transporters.forEach((transporter) => {
    ...
    describe(transporter, () => {
      ...
      if (['mailgun-api', 'postmark-api', 'mandrill-api', 'resend-api', 'ses-api', 'hosting-smtp'].includes(transporter)) {
