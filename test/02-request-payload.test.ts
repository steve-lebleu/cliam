...
describe('Request payload', () => {
  ...
  describe('.meta', () => {
    ...
    beforeEach(() => { payload = JSON.parse(JSON.stringify(requestPayload())); });
    ...
    describe('.subject', () => {
      ...
      it('error - length should be less than or equals 128 chars long', (done: any) => {
    ...
    ['from', 'replyTo', 'to', 'cc', 'bcc'].forEach(property => {
      describe(`.${property}`, () => {
        ...
        if (['to', 'cc', 'bcc'].includes(property)) {
          ...
          if (property === 'to') {
            it(`error - ${property} is required`, (done: any) => {
          ...
          it(`error - ${property} must be an array`, (done: any) => {
    ...
    describe('.attachments', () => {
      ...
      it('error - must not be a sparse array item', (done: any) => {
      ...
      it('error - base64 encoded content is required', (done: any) => {
      ...
      it('error - should be a valid base64 encoded string', (done: any) => {
      ...
      it('error - filename is required', (done: any) => {
      ...
      it('error - filename should be well formed', (done: any) => {
      ...
      it('error - disposition should be one of inline|attachment', (done: any) => {
  ...
  describe('.content', () => {
    ...
    it('error - should be an array', (done: any) => {
    ...
    it('error - should match text/plain or text/html', (done: any) => {
    ...
    it('error - should have at least an text/html entry', (done: any) => {
    ...
    it('error - should have 2 distinct well formed items max', (done: any) => {
  ...
  describe('.data', () => {
    ...
    it('error - should be an object', (done: any) => {
      payload.data = 'Yoda';
      const error = mailSchema.validate(payload, { abortEarly: true, allowUnknown: false })?.error;
    ...
    it('error - cannot coexists with content', (done: any) => {
      const error = mailSchema.validate(payload, { abortEarly: true, allowUnknown: false })?.error;
